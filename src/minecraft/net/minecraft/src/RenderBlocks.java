...
public class RenderBlocks
{
    ...
    public void func_83020_a(double var1, double var3, double var5, double var7, double var9, double var11)
    {
        if (!this.field_83023_m)
        {
            this.field_83021_g = var1;
            this.field_83026_h = var7;
            this.field_83027_i = var3;
            this.field_83024_j = var9;
            this.field_83025_k = var5;
            this.field_83022_l = var11;
        }
    }

    public void func_83018_a(Block var1)
    {
        if (!this.field_83023_m)
        {
            this.field_83021_g = var1.func_83009_v();
            this.field_83026_h = var1.func_83007_w();
            this.field_83027_i = var1.func_83008_x();
            this.field_83024_j = var1.func_83010_y();
            this.field_83025_k = var1.func_83005_z();
            this.field_83022_l = var1.func_83006_A();
        }
    }

    public void func_83019_b(double var1, double var3, double var5, double var7, double var9, double var11)
    {
        this.field_83021_g = var1;
        this.field_83026_h = var7;
        this.field_83027_i = var3;
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        switch (var5)
        {
            ...
            case 32:
                return this.func_82779_a((BlockWall)par1Block, par2, par3, par4);
            case 12:
            ...
            case 33:
                return this.func_82780_a((BlockFlowerPot)par1Block, par2, par3, par4);
            case 35:
                return this.func_82775_a((BlockAnvil)par1Block, par2, par3, par4);
            case 25:
            ...
            case 34:
                return this.func_82778_a((BlockBeacon)par1Block, par2, par3, par4);
            default:
    ...
    public boolean func_82780_a(BlockFlowerPot par1BlockFlowerPot, int par2, int par3, int par4)
    {
    ...
    public boolean func_82775_a(BlockAnvil par1BlockAnvil, int par2, int par3, int par4)
    {
        Tessellator var5 = Tessellator.instance;
    ...
    public boolean renderBlockTripWireSource(Block par1Block, int par2, int par3, int par4)
    {
        ...
        var25[0] = this.blockAccess.func_82732_R().getVecFromPool((double)(-var62), 0.0D, (double)(-var38));
        var25[1] = this.blockAccess.func_82732_R().getVecFromPool((double)var62, 0.0D, (double)(-var38));
        var25[2] = this.blockAccess.func_82732_R().getVecFromPool((double)var62, 0.0D, (double)var38);
        var25[3] = this.blockAccess.func_82732_R().getVecFromPool((double)(-var62), 0.0D, (double)var38);
        var25[4] = this.blockAccess.func_82732_R().getVecFromPool((double)(-var62), (double)var39, (double)(-var38));
        var25[5] = this.blockAccess.func_82732_R().getVecFromPool((double)var62, (double)var39, (double)(-var38));
        var25[6] = this.blockAccess.func_82732_R().getVecFromPool((double)var62, (double)var39, (double)var38);
        var25[7] = this.blockAccess.func_82732_R().getVecFromPool((double)(-var62), (double)var39, (double)var38);
    ...
    public boolean func_82778_a(BlockBeacon par1BlockBeacon, int par2, int par3, int par4)
    {
        float var5 = 0.1875F;
