...
public class BlockDispenser extends BlockContainer
{
    ...
    private void func_82526_n(World par1World, int par2, int par3, int par4)
    {
        ...
        if (var6 != null)
        {
            ...
            else
            {
                ...
                IBehaviorDispenseItem var9 = (IBehaviorDispenseItem)field_82527_a.func_82594_a(var8.getItem());
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            this.func_82526_n(par1World, par2, par3, par4);
        }
    }
    ...
    public static IPosition func_82525_a(IBlockSource par0IBlockSource)
    {
        ...
        double var2 = par0IBlockSource.func_82615_a() + 0.6D * (double)var1.func_82601_c();
        double var4 = par0IBlockSource.func_82617_b();
        double var6 = par0IBlockSource.func_82616_c() + 0.6D * (double)var1.func_82599_e();
